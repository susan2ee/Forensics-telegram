# Telegram artifact extractor for memory dump analysis.
# Scans raw dump data and exports parsed Telegram-related results as JSON.
...
# Scan the memory dump for known Telegram signatures and collect parsed results.
